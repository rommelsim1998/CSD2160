/******************************************************************************
* \file          Cave7.cpp
* \brief         This file is the main file for Cave 7
...
Cave7::Cave7(int id)
	: GameObject(TYPE_CAVE7, id), test{13}
{
}
...
void Cave7::GameObjectInitialize()
{
	SetScale(100.0f);
}

void Cave7::GameObjectUpdate()
{
	// ChangeState();
