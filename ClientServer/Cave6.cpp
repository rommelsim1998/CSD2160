/******************************************************************************
* \file          Cave6.cpp
* \brief         This file is the main file for Cave 6
...
Cave6::Cave6(int id)
	: GameObject(TYPE_CAVE6, id), test{ 12 }
{
}
...
void Cave6::GameObjectInitialize()
{
	SetScale(100.0f);
}

void Cave6::GameObjectUpdate()
{
	//ChangeState();
