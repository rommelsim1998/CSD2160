/******************************************************************************
* \file          GameState_Level7.cpp
* \brief         This file is the main file for Game state of level 7
...
/*!
	...
	*/
	/**************************************************************************/
void GameStateLevel7Load(void)
{

	_tm.TileManagerLoad("Resources/Level 7.txt");
...
/*!
	...
	*/
	/**************************************************************************/
void GameStateLevel7Update(void)
{
	if (!isPaused)
	{
...
/*!
	...
	*/
	/**************************************************************************/
void GameStateLevel7Unload(void)
{
