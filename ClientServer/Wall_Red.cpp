...
\brief
	...
	from GameObject. Initializing the color to red;

\param id
	The id value tagged to the wall object.
*/
/**************************************************************************/
Wall_Red::Wall_Red(int id)
	: GameObject(TYPE_WALL_RED, id), test{ 9 }
{
...
*/
/**************************************************************************/
void Wall_Red::GameObjectInitialize()
{
	SetHasGravity(false);
	SetScale(55.0f);
}
...
*/
/**************************************************************************/
void Wall_Red::GameObjectUpdate()
{
	//ChangeState();
	...
	// Setting of bounding box for Wall_Red Object
	AABB boundbox;
