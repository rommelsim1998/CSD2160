/******************************************************************************
* \file          Cave3.cpp
* \brief         This file is the main file for Cave 3
...
Cave3::Cave3(int id) 
	: GameObject(TYPE_CAVE3, id), test{ 9 }
{
}
...
void Cave3::GameObjectInitialize()
{
	SetScale(100.0f);
}

void Cave3::GameObjectUpdate()
{
	//ChangeState();
