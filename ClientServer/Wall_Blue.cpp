/******************************************************************************
* \file			Wall_Blue.cpp
* \brief		This file handles the initializing of wall_blue object, updates in
				which the wall_blue does when player interacts with, and drawing the
				wall_blue object.
...
\brief
	...
	from GameObject. Initializing the color to blue;

\param id
	The id value tagged to the wall object.
*/
/**************************************************************************/
Wall_Blue::Wall_Blue(int id)
	: GameObject(TYPE_WALL_BLUE, id), test{ 9 }
{
...
*/
/**************************************************************************/
void Wall_Blue::GameObjectInitialize()
{
	SetHasGravity(false);
	SetScale(55.0f);
}
...
*/
/**************************************************************************/
void Wall_Blue::GameObjectUpdate()
{
	//ChangeState();
	...
	// Setting of bounding box for Wall_Blue Object
	AABB boundbox;
