/******************************************************************************
* \file          GameState_Level2.cpp
* \brief         This file is the main file for Game state of level 2
...
void GameStateLevel2Load(void)
{
	...
	_tm.TileManagerLoad("Resources/Level 2.txt");
...
/*!
	...
	*/
	/**************************************************************************/
void GameStateLevel2Update(void)
{
	if (!isPaused)
	{
