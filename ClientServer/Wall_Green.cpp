/******************************************************************************
* \file			Wall_Green.cpp
* \brief		This file handles the initializing of wall_Green object, updates in
				which the wall_Green does when player interacts with, and drawing the
				wall_Green object.
...
\brief
	...
	from GameObject. Initializing the color to green;

\param id
	The id value tagged to the wall object.
*/
/**************************************************************************/
Wall_Green::Wall_Green(int id)
	: GameObject(TYPE_WALL_GREEN, id), test{ 9 }
{
...
*/
/**************************************************************************/
void Wall_Green::GameObjectInitialize()
{
	SetHasGravity(false);
	SetScale(55.0f);
}
...
*/
/**************************************************************************/
void Wall_Green::GameObjectUpdate()
{
	//ChangeState();
	...
	// Setting of bounding box for Wall_Green Object
	AABB boundbox;
...
*/
/**************************************************************************/
void Wall_Green::GameObjectDraw()
{
