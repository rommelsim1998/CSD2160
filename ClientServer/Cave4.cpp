/******************************************************************************
* \file          Cave4.cpp
* \brief         This file is the main file for Cave 4
...
Cave4::Cave4(int id)
	: GameObject(TYPE_CAVE4, id), test{ 10 }
{
}
...
void Cave4::GameObjectInitialize()
{
	SetScale(100.0f);
}

void Cave4::GameObjectUpdate()
{
	//ChangeState();
