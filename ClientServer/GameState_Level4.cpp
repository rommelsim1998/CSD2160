/******************************************************************************
* \file          GameState_Level4.cpp
* \brief         This file is the main file for Game state of level 4
...
/*!
	...
	*/
	/**************************************************************************/
void GameStateLevel4Load(void)
{
	
	_tm.TileManagerLoad("Resources/Level 4.txt");
...
/*!
	...
	*/
	/**************************************************************************/
void GameStateLevel4Update(void)
{
	if (!isPaused)
	{
...
/*!
	...
	*/
	/**************************************************************************/
void GameStateLevel4Unload(void)
{
