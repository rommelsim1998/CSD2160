/******************************************************************************
* \file          GameState_Level6.cpp
* \brief         This file is the main file for Game state of level 6
...
/*!
	...
	*/
	/**************************************************************************/
void GameStateLevel6Load(void)
{

	_tm.TileManagerLoad("Resources/Level 6.txt");
...
/*!
	...
	*/
	/**************************************************************************/
void GameStateLevel6Update(void)
{
	if (!isPaused)
	{
...
/*!
	...
	*/
	/**************************************************************************/
void GameStateLevel6Unload(void)
{
