/******************************************************************************
* \file          Cave1.cpp
* \brief         This file is the main file for Cave 1
...
Cave1::Cave1(int id) 
	: GameObject(TYPE_CAVE1, id), test{ 9 }
{
}
...
void Cave1::GameObjectInitialize()
{
	SetScale(100.0f);
}

void Cave1::GameObjectUpdate()
{
	//ChangeState();
